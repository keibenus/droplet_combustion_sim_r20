...
def plot_results(times, results_list, output_dir, nsp, Nl_init, Ng_init, gas_props: GasProperties):
    ...
    # --- Plot 5: Fuel Mass Fraction Profile (from CSV files) ---
    plt.figure(figsize=(12, 7))
    ...
    plotted_count = 0
    # profiles_dir, all_files, plot_indicesはPlot 4のブロックで定義済み
    ...
    if plotted_count > 0:
        ...
        print("No valid data to plot fuel fraction profiles.")
    plt.close()

    # --- Plot 6: Other Species Profiles (from CSV files) ---
