...
def _residual_wrapper_for_solver(T_s_guess, T_l_node_last, T_g_node0, Y_g_node0, P, R, r_l_node_last_center, r_g_node0_center, gas_props, liquid_props, Nl, fugacity_interpolator, k, epsilon):
    ...
    residual, _, _, _, _ = _interface_energy_residual_full(T_s_guess, T_l_node_last, T_g_node0, Y_g_node0, P, R, r_l_node_last_center, r_g_node0_center, gas_props, liquid_props, Nl, fugacity_interpolator, k, epsilon)
    return residual
...
def solve_interface_conditions(
    ...
    try:
        ...
        res_low, _, _, _, _ = _interface_energy_residual_full(T_lower_bound, T_l_node_last, T_g_node0, Y_g_node0, P, R, r_l_node_last_center, r_g_node0_center, gas_props, liquid_props, Nl, fugacity_interpolator, k, epsilon)
        res_high, _, _, _, _ = _interface_energy_residual_full(T_upper_bound, T_l_node_last, T_g_node0, Y_g_node0, P, R, r_l_node_last_center, r_g_node0_center, gas_props, liquid_props, Nl, fugacity_interpolator, k, epsilon)
        ...
        if not (np.isfinite(res_low) and np.isfinite(res_high)):
            ...
            T_s_solution, r_info = op.brentq(
                ...
                args=(T_l_node_last, T_g_node0, Y_g_node0, P, R, r_l_node_last_center, r_g_node0_center, gas_props, liquid_props, Nl, fugacity_interpolator, k, epsilon),
    ...
    try:
        ...
        final_residual_check, q_gas_out_surf_final, q_liq_out_surf_final, mdot_final, delta_nu_final = _interface_energy_residual_full(
