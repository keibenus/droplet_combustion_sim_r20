...
# --- Output Options ---
OUTPUT_DIR = 'results_r20_r03' # Changed output dir name
...
T_END = 10e-3 # s (Simulation end time, 延長)
...
IGNITION_CRITERION_DTDT = 3.0e6  # K/s (Max gas temperature rise rate) - Not implemented as termination in this version
IGNITION_CRITERION_TMAX = 9999.0  # K (Max gas temperature)
